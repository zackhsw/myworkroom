...
public class CircleImageView extends ImageView {
    ...
    protected void onDraw(Canvas paramCanvas) {
        ...
        /** 将drawable绑定到bitmap(this.mask)上面（drawable只能通过bitmap显示出
         来） */
...
//        super.onDraw(paramCanvas);
    ...
    private void drawBorder(Canvas canvas, final int width, final int height) {
        ...
        /**
         * 坐标x：view宽度的一般 坐标y：view高度的一般 半径r：因为是view的宽度-
         border的一半
         */
     ...
     * <p>
     * 将这个bitmap放在canvas上面承载，并在其上面画一个椭圆(其实也是一个圆，因为
     width=height)来固定显示区域
     *
     * @param width
     * @param height
     * @return
    ...
    public Bitmap createOvalBitmap(final int width, final int height) {
        ...
        /**
         * 设置椭圆的大小(因为椭圆的最外边会和border的最外边重合的，如果图片最外
         边的颜色很深，有看出有棱边的效果，所以为了让体验更加好，
         * 让其缩进padding px)
         */
